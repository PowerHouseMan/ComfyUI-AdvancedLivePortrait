    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                ...
                "aaa": ("FLOAT", {"default": 0, "min": 0, "max": 120, "step": 1, "display": display}),
                "eee": ("FLOAT", {"default": 0, "min": 0, "max": 15, "step": 0.2, "display": display}),
                "woo": ("FLOAT", {"default": 0, "min": 0, "max": 15, "step": 0.2, "display": display}),
                "smile": ("FLOAT", {"default": 0, "min": 0, "max": 1.3, "step": 0.01, "display": display}),
